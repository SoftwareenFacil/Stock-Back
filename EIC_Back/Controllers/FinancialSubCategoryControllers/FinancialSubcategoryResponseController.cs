...
namespace EIC_Back.Controllers.FinancialSubCategoryApiControllers
{
    public class FinancialSubcategoryResponseController
    {
        ...
        public async Task<IActionResult> GetResponseFinancialSubCategory(int id, int? categoryid)
        {
            var FinancialSubCategory = await _financialSubcategoryService.GetFinancialSubCategory(id, categoryid);
